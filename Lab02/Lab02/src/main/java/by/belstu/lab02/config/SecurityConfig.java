    ...
    public SecurityFilterChain filterChain(HttpSecurity http)
        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/view-rooms-worker").hasAnyAuthority(Roles.ADMIN.toString(), Roles.WORKER.toString())
                        .requestMatchers("/view-type-rooms-worker").hasAnyAuthority(Roles.ADMIN.toString(), Roles.WORKER.toString())
                        .requestMatchers("/view-rooms").hasAuthority(Roles.ADMIN.toString())
                        .requestMatchers("/view-type-rooms").hasAnyAuthority(Roles.ADMIN.toString())
