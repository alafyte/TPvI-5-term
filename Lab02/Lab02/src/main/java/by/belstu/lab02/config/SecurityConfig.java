    ...
    public SecurityFilterChain filterChain(HttpSecurity http)
        ...
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/ViewWorker").hasAuthority(Roles.ADMIN.toString())
                        ...
                        .requestMatchers("/CreateWorker").hasAuthority(Roles.ADMIN.toString())
                        ...
                        .requestMatchers("/EditWorker/*").hasAuthority(Roles.ADMIN.toString())
                        ...
                        .requestMatchers("/DeleteUser/*").hasAuthority(Roles.ADMIN.toString())
                        .requestMatchers("/DeleteWorker/*").hasAuthority(Roles.ADMIN.toString())
                        )
